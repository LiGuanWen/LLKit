//
//  LLSlidePageScrollViewController.m


#import "LLSlidePageScrollViewController.h"

@interface LLSlidePageScrollViewController ()
@property (nonatomic, weak) LLSlidePageScrollView *slidePageScrollView;
@end

@implementation LLSlidePageScrollViewController
...
{
    LLSlidePageScrollView *slidePageScrollView = [[LLSlidePageScrollView alloc]initWithFrame:self.view.bounds];
...
#pragma mark - LLSlidePageScrollViewDataSource
...
{
    UIViewController<LLDisplayPageScrollViewDelegate> *viewController = _viewControllers[index];
