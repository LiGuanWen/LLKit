...
-(id)initWithHandler:(WVJBHandler)messageHandler resourceBundle:(NSBundle*)bundle
{
    ...
    self.JSresponseCallbacks = [NSMutableDictionary dictionary];
    _uniqueId = 0;
    return(self);
}

- (void)dealloc {
    self.JSresponseCallbacks = nil;
    ...
    for (WVJBMessage* message in messages) {
        ...
        if (responseId) {
            ...
            if (message[@"handlerName"]) {
                ...
                [self.JSresponseCallbacks  setObject:[responseCallback copy] forKey:message[@"handlerName"]];
